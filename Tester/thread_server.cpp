...
void *Thread_Server::server_thread(void *p) {
    ...
    this_p->server_connection.setup_connection((char *)"127.0.0.1",
                                               (char *)"10006");
    ...
    for (;;) {
        ...
        this_p->server_connection.send_udp(server.c_str(), (char *)"127.0.0.1",
                                           port.c_str());
    }
...
void *Thread_Server::client_thread(void *p) {
    ...
    // Thread_Server* this_p = (Thread_Server*)p;
    // std::string buffer;
    // this_p->client_connection.setup_connection((char*)"127.0.0.1",
    // this_p->port_client);
    ...
    // this_p->client_connection.send_udp((char*)"henlo der",
    // (char*)"127.0.0.1", this_p->port_server);
    // this_p->client_connection.recv_udp(buffer);
    // std::cout << "Received from server: " << buffer << std::endl;
    // this_p->client_connection.send_udp(buffer, (char*)"127.0.0.1",
    // this_p->port_server);
